...
(async () => {
  ...
  errors.push('--- SHEET TEXT ---'); errors.push(sheetText.slice(sheetText.indexOf('Sessions'), sheetText.indexOf('Sessions') + 500));
  await page.screenshot({ path: '/tmp/dbg-sheet2.png' });
  await browser.close();
